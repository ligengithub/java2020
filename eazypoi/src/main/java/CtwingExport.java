...
//import module.source.CtwingModule;
//import module.export.ExportModal;
//import module.util.EncodeUtils;
...
//
//
////        byte[] bytes = module.util.EncodeUtils.decodeHex(module.getPayload().getAPPdata());
...
//            }
//            if (StringUtils.equals(cmdFlag, "00")&&!StringUtils.equals(eventFlag, "05")){
//                exportModal.setRemark("心跳");
//            }
//
